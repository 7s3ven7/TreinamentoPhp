...
namespace aprendizado\composer\vendor\monolog\monolog\tests\Monolog\Formatter;
...
class LineFormatterTest extends \PHPUnit_Framework_TestCase
{
    ...
    public function testDefFormatWithObject()
    {
        ...
        $message = $formatter->format(array(
            ...
            'context' => array(),
            'datetime' => new \DateTime,
            'extra' => array('foo' => new \Monolog\Formatter\TestFoo, 'bar' => new \Monolog\Formatter\TestBar, 'baz' => array(), 'res' => fopen('php://memory', 'rb')),
            'message' => 'foobar',
        ));
