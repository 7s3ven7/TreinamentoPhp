...
class DataValidator
{
    ...
    public float $front, $back, $leftSide, $rightSide, $totalArea;

    public string $property, $plot, $square;
    ...
    public function getValues():bool
    {
        ...
        $this->totalArea = $areaValidator->validator($this->front, $this->back, $this->rightSide, $this->leftSide);
        ...
        $this->values['installmentNumber'] = $_POST['installmentNumber'];
        $this->values['installmentValue'] = $installmentValidator->validator($this->values['price'], $this->values['installmentNumber']);
