...
use Validator\DataPostValidator;
use Validator\AreaValidator;
...
class ToStorePageFormat
{
    ...
    public float $totalArea,$totalValueInstallment,$individualValueInstallment;

    public array $pageOne;

    public array $pageTwo;

    public array $pageThree;
    ...
    public function __construct()
    {
        ...
        $this->data = new DataPostValidator();
        ...
        $this->totalArea = $areaValidator->validator($this->data->front,$this->data->back,$this->data->rightSide,$this->data->leftSide);

        $installmentValidator = new InstallmentValidator();

        $this->totalValueInstallment = $installmentValidator->validator($this->data->price);

        $this->individualValueInstallment = $this->totalValueInstallment/$this->data->installment;
    ...
    public function pageOne():void
    {
        ...
        $twoParagrafeAfterTableSize = [
            ...
            [
                ...
                "html" => "2. Taxa de CORRETAGEM no valor total de " . $this->data->price . ", podendo ser dividida em até " . $this->data->installment . " parcelas. ",
                "align" => "L"
            ],
        ];
        ...
        $bodyTablePrice = [
            ...
            [
                ...
                "html" => "R$" . $this->individualValueInstallment,
                "align" => "C",
                'border' => true
            ],
            [
        ...
        $twoParagrafeAfterTablePrice = [
            [
                ...
                "html" => "3. O preço do lote à vista é de " . $this->data->price . ".",
                "align" => "L"
            ],
            [
                "position" =>
...
mensais, vencendo a 1ª (primeira) e as demais consecutivamente a cada 30 dias corridos, a partir da data de pagemento da última parcela dos honorários de CORRETAGEM especificada no item 2 dessa proposta.",
        ...
        for($i = 1;$i <= $this->data->installment;$i++)
        {
